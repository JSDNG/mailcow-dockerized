...
class __TwigTemplate_347783777f3c97a0e6ad48bbdddfff7b extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield "<div class=\"tab-pane fade\" id=\"tab-templates-mbox\" role=\"tabpanel\" aria-labelledby=\"tab-templates-mbox\">
  <div class=\"card mb-4\">
    <div class=\"card-header d-flex fs-5\">
      <button class=\"btn d-sm-block d-md-none flex-grow-1 text-start\" data-bs-target=\"#collapse-tab-templates-mbox\" data-bs-toggle=\"collapse\" aria-controls=\"collapse-tab-templates-mbox\">
        ";
        // line 5
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["lang"] ?? null), "mailbox", [], "any", false, false, false, 5), "mailbox_templates", [], "any", false, false, false, 5), "html", null, true);
        yield " <span class=\"badge bg-info table-lines\"></span>
      </button>
      <span class=\"d-none d-md-block\">";
        // line 7
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["lang"] ?? null), "mailbox", [], "any", false, false, false, 7), "mailbox_templates", [], "any", false, false, false, 7), "html", null, true);
    ...
    <div id=\"collapse-tab-templates-mbox\" class=\"card-body collapse\" data-bs-parent=\"#mail-content\">
      <div class=\"mass-actions-mailbox mb-4 d-none d-sm-block\">
        ...
        if ((($context["mailcow_cc_role"] ?? null) == "admin")) {
            // line 20
            yield "              <li><a class=\"dropdown-item\" data-action=\"delete_selected\" data-id=\"mailbox_template\" data-api-url='delete/mailbox/template' href=\"#\">";
        ...
        if ((($context["mailcow_cc_role"] ?? null) == "admin")) {
            // line 27
            yield "          <button class=\"btn btn-sm btn-success\" data-bs-toggle=\"modal\" data-bs-target=\"#addMailboxTemplateModal\"><i class=\"bi bi-plus-lg\"></i> ";
      ...
      <div class=\"mass-actions-mailbox mt-4\">
        <div class=\"btn-group\">
          <button class=\"btn btn-sm btn-xs-lg btn-xs-half btn-secondary\" id=\"toggle_multi_select_all\" data-id=\"mailbox_template\" href=\"#\"><i class=\"bi bi-check-all\"></i> ";
        // line 34
        ...
        if ((($context["mailcow_cc_role"] ?? null) == "admin")) {
            // line 45
            yield "          <button class=\"btn btn-sm btn-xs-lg btn-success\" data-bs-toggle=\"modal\" data-bs-target=\"#addMailboxTemplateModal\"><i class=\"bi bi-plus-lg\"></i> ";
